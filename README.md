...
- `python main.py <-o/--overview>` : Authenticates the user and prints the number of diary entries and the users current balance.
...
- `python main.py <-b/--budget>` : Authenticates the user and adds budgets after taking input for overall then all categorical budgets.
- `python main.py <-v/--view_budget>` : Authenticates the user and prints all the budgets the user has set.
